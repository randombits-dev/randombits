...
title: "Advanced Vercel Guide without NextJS"
summary: "Even if you are not using the NextJS framework, Vercel is a great option for running your static or nodejs applications. It is super easy to use, fast, and free. This guide is intended to show you some tips and tricks."
date: "January 01, 2023"
---

# Advanced Vercel Guide without NextJS

Even if you are not using the NextJS framework, Vercel is a great option for running your static or nodejs applications. 
It is super easy to use, fast, and free. This guide is intended to show you some tips and tricks
